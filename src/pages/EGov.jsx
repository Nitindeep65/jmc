...
const egovServices = [
  ...
  { name: 'Online Grievance Redressal', href: 'https://jmc.jk.gov.in/OnlineGrievances.aspx', desc: 'Register and track your complaints online.' },
  { name: 'Building Plan Permission', href: 'https://jmc.jk.gov.in/PermissionForm.aspx', desc: 'Apply for building plan sanction online.' },
  { name: 'Birth & Death Certificate', href: 'https://serviceonline.gov.in/jammu/', desc: 'Apply via JAKSMAC e-service portal.' },
  { name: 'Trade License', href: 'https://jmc.jk.gov.in/easedoing.html', desc: 'Apply/renew trade license online.' },
  { name: 'E-Newsletter', href: 'https://jmc.jk.gov.in/newsletter.aspx', desc: 'Download JMC e-newsletters and publications.' },
  { name: 'PDD E-Services', href: 'https://jmc.jk.gov.in/pddeservices.html', desc: 'Access PDD (Power) department e-services.' },
